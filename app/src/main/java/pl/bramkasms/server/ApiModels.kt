...
@Serializable data class MessageRequest(val recipient: String, val content: String, val externalId: String? = null, val removePolishCharacters: Boolean = true)
...
@Serializable data class SettingsRequest(val port: Int, val delayMs: Long, val maxRetries: Int, val removePolishByDefault: Boolean, val allowedSubnetPrefix: String = "")
@Serializable data class SettingsResponse(val port: Int, val delayMs: Long, val maxRetries: Int, val removePolishByDefault: Boolean, val queuePaused: Boolean, val allowedSubnetPrefix: String)
...
fun SettingsEntity.response() = SettingsResponse(port, delayMs, maxRetries, removePolishByDefault, queuePaused, allowedSubnetPrefix)
